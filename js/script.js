document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            nav_contact: "Contact",
            hero_title: "AURA",
            hero_subtitle: "when serenity becomes the essence<br>of opulence",
            ...
            features_title: "AURA's Signature",
            features_subtitle: "When design speaks in silence",
            signature_intro: "In the world of AURA, the signature is not just seen by the client's eye, but felt and lived by the soul. At AURA, we believe that true design does not need an explicit signature, but leaves a state of stillness and unforgettable opulence.",
            signature_list_intro: "At AURA:",
            ...
            about_us_philosophy_title: "Our Philosophy",
            about_us_philosophy_subtitle: "\"When serenity becomes the essence of opulence\"",
            about_us_intro: "At <span class=\"aura-highlight\">AURA</span>, we live this philosophy as our working methodology. We believe that serenity is not merely a result of design, but the true essence from which architectural opulence is derived. Our mission is to craft spaces that transcend the concept of superficial beauty, offering our clients a precise balance that combines absolute elegance with visual tranquility, making spaces a unique investment in quality of life.",
            about_us_vision_title: "Our Vision",
            about_us_vision: "To become the primary reference in crafting spaces that breathe, inspire those around them, and immerse their inhabitants in a profound sense of peace and rootedness.",
            about_us_mission_title: "Our Mission",
            about_us_mission: "To deliver interior and architectural design that transcends function, using refined methodologies in handling light, texture, and materials, to create environments that transport our clients to a state of absolute serenity.",
            about_us_values_title: "Our Core Values",
            about_us_value_1_title: "Serenity:",
            about_us_value_1_desc: "Commitment to design that soothes the soul and is free from visual noise.",
            about_us_value_2_title: "Rooted:",
            about_us_value_2_desc: "Preserving material authenticity, the warmth of place, and connection to nature.",
            about_us_value_3_title: "Boldness:",
            about_us_value_3_desc: "Challenging the conventional through masterful surprises in texture, color, and light.",
            about_us_value_4_title: "Commitment:",
            about_us_value_4_desc: "Dedication to silent, refined expertise to achieve the highest levels of quality.",
        ...
        ar: {
            ...
            hero_title: "AURA",
            hero_subtitle: "حين تغدو السكينة جوهر الفخامة",
            ...
            features_title: "AURA بصمة",
            features_subtitle: "حين يتحدث التصميم بصمت",
            signature_intro: "في عالم AURA ، لا ترى البصمة بعين العميل فقط، بل تحس وتعاش بالروح. في AURA، نؤمن بأن التصميم الحقيقي لا يحتاج الى توقيع صريح، بل يترك حالة من السكون والفخامة التي لا تنسى.",
            signature_list_intro: "في AURA :",
            ...
            about_us_philosophy_title: "فلسفتنا",
            about_us_philosophy_subtitle: "\"حين تغدو السكينة جوهر الفخامة\"",
            about_us_intro: "في <span class=\"aura-highlight\">AURA</span>، نعيش هذه الفلسفة كمنهاج عمل. نحن نؤمن بأن السكينة ليست مجرد نتيجة للتصميم، بل هي الجوهر الحقيقي الذي يستمد منه الفخامة المعمارية. مهمتنا هي صياغة مساحات تتجاوز مفهوم الجمال الظاهري، لنقدم لعملائنا توازنا دقيقا يجمع ما بين الرقي المطلق والسكينة البصرية، مما يجعل المساحات استثمارا فريدا في نوعية الحياة.",
            about_us_vision_title: "رؤيتنا",
            about_us_vision: "أن نكون المرجعية الأولى في صياغة مساحات تتنفس، تلهم من حولها، تغمر ساكنيها بإحساس عميق بالسلام والتجذر.",
            about_us_mission_title: "رسالتنا",
            about_us_mission: "تقديم تصميم داخلي ومعماري يتجاوز الوظيفة، باستخدام منهجيات متقنة في التعامل مع الضوء والملمس والمواد، لخلق بيئات تنقل عملائنا الى حالة من السكينة المطلقة.",
            about_us_values_title: "قيمنا",
            about_us_value_1_title: "السكينة:",
            about_us_value_1_desc: "الالتزام بالتصميم الذي يريح الروح ويخلو من الضجيج البصري.",
            about_us_value_2_title: "التجذر:",
            about_us_value_2_desc: "الحفاظ على أصالة المادة ودفء المكان، والإرتباط بالطبيعة.",
            about_us_value_3_title: "الجرأة:",
            about_us_value_3_desc: "تحدي المألوف على المفاجئات المتقنة في الملمس واللون والضوء.",
            about_us_value_4_title: "الإلتزام:",
            about_us_value_4_desc: "الإلتزام بخبرة صامتة ومتقنة لتحقيق أعلى درجات الجودة.",
            about_us_tagline: "We design life"
        }
    };
